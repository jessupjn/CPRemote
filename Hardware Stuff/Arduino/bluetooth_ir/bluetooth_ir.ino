...
char* typeToChar(IRTYPES type) {
  switch(type) {
    case NEC:            return "NEC";
    case NECX:           return "NECX";
    case SONY:           return "SONY";
    case RC5:            return "RC5";
    case RC6:            return "RC6";
    case PANASONIC_OLD:  return "PANASONIC_OLD";
    case JVC:            return "JVC";
    case GICABLE:        return "GICABLE";
  }
}
...
////Serial.println("GICABLE");
    ...
    s_size = strlen((char*)typeToChar(My_Decoder.decode_type)); 
    memcpy (recvddata+senddatasize, typeToChar(My_Decoder.decode_type),s_size);
    senddatasize+=s_size; 
  }
...
void loop() {
  ...
  if (bluetooth.overflow()) {
    Serial.println("Bluetooth overflow!"); 
    bluetooth.flush();
  }
...
// charToType (b_protocol, b_code, b_nbits, b_protocol_enum, b_code_long, b_nbits_long); 
